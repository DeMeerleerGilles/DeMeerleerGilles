...
## Tech stack
<div align="center">
   <img src="https://skillicons.dev/icons?i=cloudflare,html,css,js,bootstrap,dotnet,figma,azure,git,java,cs,jenkins,latex,mysql,nginx,php,py,raspberrypi,redhat,ubuntu,kali,debian,docker,ansible,bash,visualstudio,vscode,androidstudio,wordpress,windows&perline=6"/>
</div>
